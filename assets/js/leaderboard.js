/*
=================================================
Crimson Crown - Leaderboard Page Script
=================================================
This script handles:
1. Fetching the sorted leaderboard data from the backend.
...
document.addEventListener('DOMContentLoaded', async () => {
    // Get references to the key elements on the page that we will manipulate.
    const podiumSection = document.getElementById('leaderboard-podium');
    const tableBody = document.getElementById('leaderboard-body');
    const loader = document.getElementById('leaderboard-loader');

    try {
        // Fetch the leaderboard data from our secure serverless function.
        ...
        // This section will only run if there are at least 3 teams in the leaderboard data.
